...
coxIntContour3D<-function(data,trainModel,contCov,contCovName=NULL,nCovEval=30,otherCov=NULL,CI3D=FALSE){
  if(is.null(otherCov)){
  ...
  s<-contour3D(ctime,newData[,contCov],predictPlot,contCovName,CI3D)
  s
}
